...
import {
    ...
    pickNotDeprecated,
    useWarnAboutChange, TitleProps,
} from "@refinedev/core";
import {RefineThemedLayoutV2SiderProps, useSiderVisible} from "@refinedev/mui";
...
export const Sider: React.FC<RefineThemedLayoutV2SiderProps> = ({
    ...
    const drawerWidth = () => {
        if (drawerSiderVisible) return 200;
        return 56;
    };
    ...
    const Title: React.FC<TitleProps> = ({ collapsed }) => {
        return <h1>{collapsed ? 'ACS' : 'Title Example'}</h1>;
    };
